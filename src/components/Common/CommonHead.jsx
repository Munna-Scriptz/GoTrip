  ...
  return (
    <>
        <div className='flex items-center justify-between'>
            ...
            <div>
                <Link to={'/'} class="overflow-hidden w-[243px] h-[50px] flex items-center justify-center bg-[#3554D10D] rounded-[5px] text-brand border-none cursor-pointer relative z-10 group">
                    ...
                    <span class="group-hover:opacity-100 text-white group-hover:duration-1000 duration-100 opacity-0 absolute top-[13px] left-10 z-10 flex items-center gap-[13px]" >Explore Now! <MdArrowOutward size={25} /></span>
                </Link>
            </div>
        </div>
    </>
